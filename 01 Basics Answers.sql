...
--- 01.show tables emloyee and department
select * from employees,departments;
select * from employees;
select * from departments;

--- 02.Display only the hire date and employee name for each employee
select concat(first_name ," " , last_name) as emp_name, hire_date from employees;

--- 03.Display the ename concatenated with the job ID, separated by a comma and space, and name the column Employee and Title
select concat_ws(', ', concat(first_name ," " , last_name),job_id) as Employee_Title from employees;

--- 04.Display the hire date, name and department number for all clerks.
select concat(first_name ," " , last_name) as emp_name, hire_date, department_id,job_title  from employees join jobs where job_title like '%clerk%';

--- 05.Create a query to display all the data from the EMP table. Separate each column by a comma. Name the column THE OUTPUT 
...
--- 06.Display the names and salaries of all employees with a salary greater than 2000.
select concat(first_name, ' ',last_name) as emp_name, salary from employees where salary > 2000;

--- 07.Display the names and dates of employees with the column headers "Name" and "Start Date"
select concat(first_name, ' ',last_name) as Full_Name, hire_date as Start_Date from employees;

--- 08. Display the names and hire dates of all employees in the order they were hired.
select first_name,last_name,hire_date from employees order by hire_date;

--- 09.Display the names and salaries of all employees in reverse salary order. 
select first_name,last_name,salary from employees order by salary desc;

--- 10. Display 'ename' and "deptno" who are all earned commission and display salary in reverse order.
select concat(first_name, ' ',last_name) as Emp_Name,department_id,salary from employees where commission_pct > 0.0  order by salary desc;

--- 11.Display the last name and job title of all employees who do not have a manager
select  last_name,job_title from employees join jobs where manager_id is null;
